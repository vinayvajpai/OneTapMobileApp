...
namespace OneTapMobile.CustomControl
{
    public class CircleProgress : SKCanvasView
    {
        ...
        public static readonly BindableProperty ProgressStartColorProperty =
            BindableProperty.Create(nameof(ProgressStartColor), typeof(Color), typeof(CircleProgress), Color.FromHex("#BA4FCA"), propertyChanged: OnPropertyChanged);
        public static readonly BindableProperty ProgressEndColorProperty =
            BindableProperty.Create(nameof(ProgressEndColor), typeof(Color), typeof(CircleProgress), Color.FromHex("#FDC056"), propertyChanged: OnPropertyChanged);
        ...
        private void DrawProgressCircle(SKImageInfo info, SKCanvas canvas)
        {
            ...
            var shader = SKShader.CreateSweepGradient(
                ...
                new[]
                {
                    ...
                    (StartAngle + progressAngle + 10) / 360,
                });
